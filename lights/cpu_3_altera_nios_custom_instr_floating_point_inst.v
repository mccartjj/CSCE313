// cpu_3_altera_nios_custom_instr_floating_point_inst.v
...
`timescale 1 ps / 1 ps
module cpu_3_altera_nios_custom_instr_floating_point_inst (
	...
	fpoint_wrapper #(
		.useDivider (0)
	) cpu_3_altera_nios_custom_instr_floating_point_inst (
		.clk    (clk),    // s1.clk
