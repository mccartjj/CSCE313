...
#
/usr/local/3rdparty/altera/quartus12/nios2eds/bin/nios2-flash-programmer "../flash/myfile_cfi_flash_0.flash" --base=0x1400000 --sidp=0x19030C0 --id=0x0 --timestamp=1395863888 --device=1 --instance=0 '--cable=USB-Blaster on localhost [3-2]' --program --verbose 
